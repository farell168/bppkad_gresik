          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <input type="date" class="form-control" name="tgl_produksi" placeholder>
              ...
              <div class="row mx-auto" style="width:95%">
                 <div class="col">
                    ...
                    <!-- <td>
                            <a href="" class="btn btn-outline-primary bentuk edit"><i class='far fa-edit'></i></a>
                        </td>
                        <td>
                            <a href="" class="btn btn-outline-danger bentuk"><i class='fas fa-eraser'></i></a>
                    </td> -->
                  </tr>
                  </thead>
                  <tbody>
