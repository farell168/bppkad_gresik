        ...
        <div class="row pl-2">
            <div class="col-md-6 col-sm-12 callout callout-info">
              ...
              <p class="text-justify">
                &emsp; Pada sistem ini, digunakan untuk menggolongkan data pemasukan PAD. Sistem ini memiliki 6 Menu meliputi halaman saat ini anda lihat yaitu Dasboard, Menu Data User sebagai tempat Data User, Menu Data Pajak sebagai tempat Data Pajak, Menu Penggolongan Pajak, Menu Grafik yang isinya presentase hasil pengolompokan Data PAD, dan Cetak Laporan. 
              </p>
              <p class="text-justify">
              &emsp; Untuk lebih jelas tetang penggunaan Sistem ini, silahkan menonton video yang telah disediakan disamping berikut ini.
              </p>
            </div>
...
<script>PDFObject.embed("https://drive.google.com/file/d/1ZYrhsMvJnsHY6KK5UJpRpMfONhwRca5P/preview?usp=sharing", "#pdfView");</script>
</body>
</html>
