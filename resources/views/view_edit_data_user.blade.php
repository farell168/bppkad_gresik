              ...
              <form action="{{ route('update_user') }}" method="POST">
                ...
                @if(session('errors'))
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control"  value="{{$user->name}}" placeholder="Isikan Nama Pegawai Sesuai NIP">
                  </div> 
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="text" name="email" class="form-control"  value="{{$user->email}}" placeholder="Masukkan Email">
                  </div>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            Perhatian !
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            Jika Ingin Merubah Password, Isikan Password dan Konfirmasinya
                        </div>
                  <div class="form-group">
