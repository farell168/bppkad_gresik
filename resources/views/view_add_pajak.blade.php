        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('save_pajak') }}" method="POST">
                @csrf
                <div class="card-body">
                @if(session('errors'))
                 ...
                 <div class="form-group">
                    ...
                    <input required type="text" name="no_pajak" class="form-control" placeholder="Masukkan Nomor Wajib Pajak">
                  </div>
                 <div class="form-group">
                    <label for="exampleInputEmail1">Tanggal Transaksi</label>
                    <input required type="date" name="tanggal_bayar" class="form-control"  placeholder="Isikan Tanggal Transaksi">
                  </div> 
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alamat Objek Pajak</label>
                    <input required type="text" name="alamat_pajak" class="form-control"  placeholder="Masukkan Alamat Objek Pajak">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kecamatan</label>
                    <input required type="text" name="kecamatan" class="form-control"  placeholder="Masukkan Kecamatan Objek Pajak">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama PENANGGUNG JAWAB</label>
                    <input required type="text" name="nama_pemilik" class="form-control"  placeholder="Masukkan Nama Penanggung Jawab">
                  </div>
                  <!-- <div class="form-group">
                    <label for="exampleInputEmail1">Alamat Penanggung Jawab</label>
                    <input required type="text" name="alamat_pemilik" class="form-control"  placeholder="Masukkan Alamat Penanggung Jawab">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nomer Telepon</label>
                    <input required type="text" name="no_tlpn" class="form-control"  placeholder="Masukkan Nomer Telepon">
                  </div> -->
                  <div class="form-group">
                    <label for="exampleInputEmail1">Luas Lahan</label>
                    <input required type="number" min="1" name="luas_lahan" class="form-control"  placeholder="Masukkan Luas Lahan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Daya Tampung dan OKUPANSI PENGUNJUNG</label>
                    <input required type="number" min="0" name="daya_tampung" class="form-control"  placeholder="Masukkan Jumlah Daya Tampung">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jumlah PEMBANGKIT</label>
                    <input required type="number" min="0" name="jumlah_pembangkit" class="form-control"  placeholder="Masukkan Jumlah Pembangkit Yang Digunakan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kapasitas Pemakaian</label>
                    <input required type="number" min="0" name="kapasitas_pemakaian" class="form-control"  placeholder="Masukkan Kapasitas Pemakaian Listrik">
                  </div>
                  <div class="form-group">
                    ...
                    <select required name="sumber_daya" id="sumber_daya" class="form-control">
                      <option value="3">Gardu Induk PLN</option>
                      <option value="2">Bantuan Swasta</option>
                      <option value="1">Tidak Ada</option>
                    </select>  
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jumlah Kamar</label>
                    <input required type="text" name="jumlah_kamar" class="form-control"  placeholder="Masukkan Jumlah Kamar">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jumlah Meja</label>
                    <input required type="text" name="jumlah_meja" class="form-control"  placeholder="Masukkan Jumlah Meja">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jumlah Sarana/Layanan</label>
                    <input required type="number" min="0" name="jumlah_sarana_layanan" class="form-control"  placeholder="Masukkan Sarana / Layanan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Jumlah Lantai</label>
                    <input required type="number" min="0" name="jumlah_lantai" class="form-control"  placeholder="Masukkan Jumlah Lantai">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input required type="number" min="1" name="tarif" class="form-control"  placeholder="Masukkan Tarif">
                  </div>
