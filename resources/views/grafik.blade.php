  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Grafik K-Means</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="card col-12 mt-2">
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Grafik Distrbusi Pengelompokan Pajak </h6>
              </div>
              <div class="card-body">
          ...
          <div class="card col-12 mt-2">
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Grafik Tarif Pengelompokan Pajak </h6>
              </div>
              <div class="card-body">
                  <div class="chart-area">
...
<script src="{{ asset('assets/dist/js/chart.min.css') }}"></script>
<script>
  $(function(){
      //get the pie chart canvas
      var cData = JSON.parse(`<?php echo $chart_data; ?>`);
      var bData = JSON.parse(`<?php echo $chart_data_2; ?>`);
      var ctx = $("#pie-chart");
      var btx = $("#bar-chart");
      ...
      var data = {
        ...
        datasets: [
          {
            label: "Jumlah Data Dalam CLuster",
            data: cData.data,
            backgroundColor: [
              "#DEB887",
              "#A9A9A9",
      ...
      var data2 = {
        ...
        datasets: [
          {
            label: "Jumlah Tarif Dalam CLuster",
            data: bData.data,
            backgroundColor: [
              "#DEB887",
              "#A9A9A9",
